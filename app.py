...
def fetch_matches_snai():
    url = 'https://betting-snai.flutterseatech.it/api/vrol-api/vrol/palinsesto/1/championships/2600302038/8135'
    headers = {
        'accept': '*/*',
        ...
        'cookie': 'akaalb_betting_snai=2147483647~op=betting_snai_flutterseatech_it:farm-b-betting_snai_flutterseatech_it|~rv=8~m=farm-b-betting_snai_flutterseatech_it:0|~os=7d012c5cf37018554175cb7a94260f94~id=4653bf308befa9a9060641c7d2d32f08'
    }
